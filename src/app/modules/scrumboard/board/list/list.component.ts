...
import { FuseConfirmDialogComponent } from 'src/app/modules/shared/components/confirm-dialog/confirm-dialog.component';
import { FusePerfectScrollbarDirective } from 'src/app/modules/shared/directives/fuse-perfect-scrollbar/fuse-perfect-scrollbar.directive';
...
export class ListComponent implements OnInit, OnDestroy 
{
  ...
  {
      this.dialogRef = this._matDialog.open(DialogsComponent, {
